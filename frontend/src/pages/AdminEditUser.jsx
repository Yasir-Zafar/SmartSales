...
export const AdminEditUser = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-900">
      <Navbar />
      <div className="p-8">
        <h2 className="text-2xl font-semibold text-gray-50">Edit User</h2>
        <p className="text-gray-400 mt-2">Welcome, {adminUser?.email}</p>

        <div className="mt-8 max-w-3xl space-y-8">
          {/* User Lookup */}
          <div className="bg-gray-800 p-8 rounded-xl shadow-xl border border-gray-700">
            <h3 className="text-xl font-semibold text-gray-50 mb-2">Find User by Email</h3>
              ...
              <p
                className={`mb-4 px-4 py-2 rounded-lg ${
                  lookupMessage.includes('success')
                    ...
                    : 'bg-rose-600/20 text-rose-400 border border-rose-600/50'
                }`}
              >
                {lookupMessage}
              </p>
            ...
            <form onSubmit={handleFindUser} className="flex flex-col md:flex-row gap-4 items-stretch md:items-end">
              <div className="flex-1">
                <label className="block mb-2 text-sm text-gray-400">User Email</label>
                <input
                  type="email"
                  value={searchEmail}
              ...
              <button
                ...
                className="md:w-auto w-full bg-teal-600 hover:bg-teal-700 disabled:bg-teal-800 text-white font-semibold py-3 px-6 rounded-lg transition-colors shadow-lg"
              >
          ...
          {selectedUser && (
            <>
              ...
              <div className="bg-gray-800 p-6 rounded-xl shadow-xl border border-gray-700">
                <h3 className="text-lg font-semibold text-gray-50 mb-4">User Summary</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <p className="text-gray-400">Name</p>
                    <p className="text-gray-50 font-medium">{selectedUser.name || '—'}</p>
                  </div>
                  <div>
                    <p className="text-gray-400">Email</p>
                    <p className="text-gray-50 font-medium">{selectedUser.email}</p>
                  </div>
                  <div>
                    <p className="text-gray-400">Role</p>
                    <p className="text-gray-50 font-medium">{selectedUser.role}</p>
                  </div>
                  <div>
                    <p className="text-gray-400">Status</p>
                    <p
                      className={`font-medium ${
                        selectedUser.active ? 'text-teal-400' : 'text-rose-400'
                      }`}
                    >
              ...
              {/* Reset Password */}
              <div className="bg-gray-800 p-6 rounded-xl shadow-xl border border-gray-700">
                <h3 className="text-lg font-semibold text-gray-50 mb-2">Reset Password</h3>
                <p className="text-gray-400 mb-4 text-sm">
                ...
                <form onSubmit={handleResetPassword} className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                  ...
                  <button
                    ...
                    className="w-full bg-teal-600 hover:bg-teal-700 disabled:bg-teal-800 text-white font-semibold py-3 px-4 rounded-lg transition-colors shadow-lg"
                  >
              ...
              {/* Update Role */}
              <div className="bg-gray-800 p-6 rounded-xl shadow-xl border border-gray-700">
                <h3 className="text-lg font-semibold text-gray-50 mb-2">Update Role</h3>
                <p className="text-gray-400 mb-4 text-sm">
              ...
              <div className="bg-gray-800 p-6 rounded-xl shadow-xl border border-gray-700">
                <h3 className="text-lg font-semibold text-gray-50 mb-2">Account Status</h3>
                <p className="text-gray-400 mb-4 text-sm">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    className={`w-full md:w-auto font-semibold py-3 px-6 rounded-lg transition-colors shadow-lg ${
                      selectedUser.active
                        ? 'bg-rose-600 hover:bg-rose-700 disabled:bg-rose-800 text-white'
                        : 'bg-teal-600 hover:bg-teal-700 disabled:bg-teal-800 text-white'
                    }`}
                  >
                    {loadingStatus
                      ? 'Updating...'
